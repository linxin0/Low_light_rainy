...
class Config(object):
    ...
    def __init__(self, config_yaml: str, config_override: List[Any] = []):
        ...
        self._C.RCD = CN()
        self._C.RCD.stage = 17
        self._C.RCD.num_M = 32
        self._C.RCD.num_Z = 32
        self._C.RCD.lr = 1e-3
        self._C.RCD.optimizer = 'ADAM'
        self._C.RCD.epsilon = 1e-8
        self._C.RCD.weight_decay = 0
        self._C.RCD.beta1 = 0.9
        self._C.RCD.beta2 = 0.999
        self._C.RCD.dir = './pretrained_models'
        self._C.RCD.scale = 2
        self._C.RCD.cpu = 'store_true'
        self._C.RCD.n_GPUs = 1
        self._C.RCD.chop= 'store_true'
        self._C.RCD.self_ensemble = 'store_true'
        self._C.RCD.precision = 'single'
        self._C.RCD.save_models = 'store_true'
        self._C.RCD.model = 'mask'
        self._C.RCD.pre_train = './pretrained_models'
        self._C.RCD.resume = 0
