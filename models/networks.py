...
def define_G(input_nc, output_nc, ngf, netG, norm='batch', use_dropout=False, init_type='normal',
    ...
    elif netG == 'encoder': # Encoder used in BIDeN.
    ...
    elif netG == 'head': # Heads used in BIDeN.
...
class Discriminator(nn.Module):
    def __init__(self, img_size=256, num_domains=5, max_conv_dim=512):
        ...
        self.main = nn.Sequential(*blocks)  # Z
        self.main2 = nn.Sequential(*blocks2)  # For discriminator
        self.main3 = nn.Sequential(*blocks3)  # For classification
